...
then
	curl --silent --location --fail --output "apache-tomcat-$VERSION.tar.gz" "https://dlcdn.apache.org/tomcat/tomcat-9/v$VERSION/bin/apache-tomcat-$VERSION.tar.gz"
fi
